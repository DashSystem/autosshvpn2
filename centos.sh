...
wget https://raw.githubusercontent.com/GegeEmbrie/autosshvpn/master/file/webmin-1.820-1.noarch.rpm
...
wget https://raw.githubusercontent.com/DashSystem/autosshvpn/master/file/cenovpn.sh
# Finishing
